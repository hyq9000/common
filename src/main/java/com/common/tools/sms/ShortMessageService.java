...
public interface ShortMessageService {
	 ...
	 */
	public String  sendMessage(String phoneNumber,String messageContent) throws Exception;
	 ...
	 */
	public String sendGroupMessage(String [] phoneNumbers,String messageContext) throws Exception;
