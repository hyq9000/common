...
public interface ICache {
	 ...
	 *            值对象
	 */
	void remove(Serializable key,String fieldName) throws Exception;
	 ...
	 *            放多长时间，单位:ms
	 */
	void put(Serializable key, String fieldName, Object value)
			throws Exception;
	 ...
	 *            放入缓存的KEY
	 * @param fieldName
	 *            键值对的KEy，如果filedName "ALL",则返回key的所有数据 ；
	 */
