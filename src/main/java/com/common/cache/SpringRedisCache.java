...
public class SpringRedisCache implements ICache {
	...
	@Override
	public Object get(final Serializable key) throws Exception {
	   return  redisTemplate.execute(new RedisCallback<Object>() {
	        @Override
	        public Object doInRedis(RedisConnection connection) throws DataAccessException {
	            try {
                   byte[] result=  connection.get(SpringRedisCache.this.getKey(key));
	...
	@Override
	public void remove(final Serializable key) throws Exception {
	...
	@Override
	public void put(final Serializable key,final Object value) throws Exception {		
	    redisTemplate.execute(new RedisCallback<Object>() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                try {
                    connection.set(SpringRedisCache.this.getKey(key), SpringRedisCache.this.object2Byte(value));
                } catch (Exception e) {
                    ExceptionLogger.writeLog(e, this.getClass());
                }
                return null;
	...
	@Override
	public void put(final Serializable key,final Object value,final long timeLength)  throws Exception{	
	    redisTemplate.execute(new RedisCallback<Object>() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                try {
                    byte[] _key=SpringRedisCache.this.getKey(key);   
                    connection.set(_key, SpringRedisCache.this.object2Byte(value));
	...
	@Override
	public void put(final Serializable key, final String fieldName, final Object value,final long timeLength) throws Exception {
	    redisTemplate.execute(new RedisCallback<Object>() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                try {
	...
	@Override
	public Object get(final Serializable key,final String fieldName)  throws Exception{
		return redisTemplate.execute(new RedisCallback<Object>() {
            @Override
            public Object doInRedis(RedisConnection connection) throws DataAccessException {
                try {
